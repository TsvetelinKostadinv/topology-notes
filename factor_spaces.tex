...
% Нека в тази секция $X, Y, Z, \dots$ означават топологични пространства, a $X^*, Y^*, Z^*, \dots$ съответно техните фактор-пространства породени от силно непрекъснатите ф-ии $p_X, p_Y, p_Z, \dots$
...
\begin{corollary}
    ...
    Тогава по \thref{th:factor-continuous} знаем, че има породена биективна\footnotemark  функция $f: X^* \to Z$, която е хомеоморфизъм, т.с.т.к. $g$ е силно непрекъсната.  
